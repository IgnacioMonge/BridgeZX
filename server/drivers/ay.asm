...
; External reference to visual feedback flag from Wifi module
visual_feedback_enabled equ Wifi.visual_feedback_enabled
...
uartRead:
    ...
    ; Si tenemos un byte guardado de la lectura anterior ("back-to-back")
    ld (hl), 0
    inc hl
    ld a, (hl)
    scf
...
startReadByte:
    di          ; <--- IMPORTANTE: Llegar aquí rapidísimo
    xor a
    exx
    ld de, (_baud) 
    ld hl, (_baud)
