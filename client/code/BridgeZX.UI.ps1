...
function Show-AboutBox {
    ...
    $lblMe=New-Object System.Windows.Forms.Label; $lblMe.Text="(c) 2025 M. Ignacio Monge García"; $lblMe.AutoSize=$true; $lblMe.Font=New-Object System.Drawing.Font("Segoe UI",9); $lblMe.Location=New-Object System.Drawing.Point(20,165); $ab.Controls.Add($lblMe)
